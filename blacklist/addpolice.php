...
<body>
    <div class="container">
        <div class="row my-5">
            <div class="col">
                <form method="POST" action="checkpd">
                    <div class="alert alert-primary" role="alert">
                        สำหรับ Blacklist ของกรมตำรวจ [TSPD]
                    </div>
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Tel" aria-label="Tel"
                            aria-describedby="basic-addon1" id="telPD" name="telPD">
                        <input type="text" class="form-control" placeholder="สาเหตุ" aria-label="Cause"
                            aria-describedby="basic-addon1" id="causePD" name="causePD">
                        <input type="text" class="form-control" placeholder="ผู้บันทึก" aria-label="Filler name"
                            aria-describedby="basic-addon1" id="fillerNamePD" name="fillerNamePD">
